...
const Listen = ({
  ...
  const [currentUsername, setCurrentUsername] = useState(
    isMock ? mockCurrentUsername : sessionStorage.getItem("username")
  );
  const [currentUser, setCurrentUser] = useState(
    isMock ? mockCurrentUser : null
  );
  const [timeLeft, setTimeLeft] = useState(30);
  const [playerId, setCurrentPlayerId] = useState(
          ...
          <>
            ...
            >
              ...
              >
                ...
                highlights of the song carefully. You will be asked to describe
                it later!
              </div>
            </div>
          </>
